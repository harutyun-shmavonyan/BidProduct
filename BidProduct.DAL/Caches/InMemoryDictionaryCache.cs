...
{
    public class InMemoryDictionaryCache<TInput, TExternalValue, TKey, TInternalValue> : IKeyValueCache<TInput, TExternalValue, TKey, TInternalValue> where TKey : notnull
    {
        ...
        public InMemoryDictionaryCache(ICacheKeyConverter<TInput, TKey> keyConverter, ICacheValueConverter<TExternalValue, TInternalValue> valueConverter)
        {
